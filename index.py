...
if df.shape[0] > 0:
    agent = create_pandas_dataframe_agent(OpenAI(temperature=0, max_tokens=6000), df, memory=state['memory'], verbose=True, return_intermediate_steps=True, max_iterations=10, max_execution_time=40)
    user_input = get_text()
